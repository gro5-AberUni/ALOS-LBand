...
agriTrainingData = 'Agri_Full_TrainingData.hdf'
...
#ffDF=ffDF.dropna(axis=0,how='any')
#bkDF=bkDF.dropna(axis=0,how='any')
#owDF=owDF.dropna(axis=0,how='any')
...
dump(scaler,open('./Scaler_Flood.pkl','wb'))
...
opt.best_estimator_.save_model('Trained_XGBoostModel_02_Amazon_Flood.model')
